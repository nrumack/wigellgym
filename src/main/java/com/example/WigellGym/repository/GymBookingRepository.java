...
public interface GymBookingRepository extends JpaRepository<GymBooking, UUID> {
    ...
    List<GymBooking> findByCanceledFalseAndGymWorkout_ScheduledAtBefore(Date date);
    List<GymBooking> findByCanceledFalseAndGymWorkout_ScheduledAtAfter(Date date);
